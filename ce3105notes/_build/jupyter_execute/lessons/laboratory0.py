...
# >Page 1. - Cover page (3 points)
# >Contains title of report, authors of report, dates of report (date of submission & date of experiment), and
# >name of report recipient (Course Instructor). Also please include your course section number.
# 
# >Page 2. – Table of Contents (5 points)
# >Contains the contents of the report including a list of figures and a list of tables.
# 
# >Page 3. - Theory page (22 points)
# Background - Contains an explaination of the theory/governing principles behind the experiment. Typically, it will
# involve application of the Continuity, Energy and/or Momentum Equations to a specific control volume
# and will result in either an equation for flow rate, pressure change or applied force that will be measured
# in the experiment. Describe any equations used to perform the analysis of the experiment.
# 
# >Page 4. - Apparatus page (5 points)
# Contain a sketch of the apparatus and a list of the variables used/measured in the experiment (with units).
# 
# >Page 5. - Results page (20 points)
...
# >2. Answer specific questions in the Interpretation Section of the Experiment Instructions.
# >3. A discussion on where discrepancies and sources of error might arise.
# >4. A real life application of this apparatus/experiment.
# 
# >Page 7. - Data Appendix (5 points)
# Contains the original data sheets for the experiment (Completely filled out).
# 
# >Page 8. Error Analysis Calculations (10 points)
# Contains a sample calculation of error analysis for one lab trial. A table of calculated error analysis values
# for all trials will be included in the error analysis section.
# 
# >Page 9. Sample Calculations (10 points)
