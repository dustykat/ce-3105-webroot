...
# 
# :::{note} 
# This section of the manual is primarily to list and describe various equipment housed, maintained, and employed in CE 3105.  The section can be considered a marketing/reporting tool for the departments, and is of marginal use to students in the lab (other than to report broken items).
# :::
# 
# ## Primary Items
# 
# The Fluids Laboratory is located in Room 191B of the CE building.  It contains one TecQuipment H1D Volumetric Bench, one TecQuipment H314 hydrostatics and fluid properties test bench, one TecQuipment H83 two-stage centrifugal pump test set, with digital pressure output and data acquisition system, one ELD Model B-16 hydraulic demonstration channel, and one Armfield S11 Groundwater Flow/Well Abstraction Apparatus.
# 
# :::{note}
# Insert photographs of equipment once move is completed; then link to experiments elsewhere in document.  Expand equipment descriptions for use of future staff as growth opportunities materialize.
# :::
# 
